...
class LoginTest(FunctionalTest):
    ...
    def wait_to_be_logged_in(self):
        ...
        self.assertIn(self.ldap_login['username'], navbar.text)

    def wait_to_be_logged_out(self):
        self.wait_for_element_with_id('id_login')
        navbar = self.browser.find_element_by_css_selector('.navbar')
        self.assertNotIn(self.ldap_login['username'], navbar.text)
    ...
    def test_login_LDAP(self):
        ...
        login.send_keys(self.ldap_login['username'])
        passwd.send_keys(self.ldap_login['password'])
